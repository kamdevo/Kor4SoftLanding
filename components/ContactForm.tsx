            ...
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg p-4 sm:p-5 text-white shadow-xl order-2 lg:order-1">
              ...
              <div className="hidden lg:block mt-3 pt-3 border-t border-white/20">
                ...
                <div className="flex gap-2 flex-wrap">
                  <a href="https://www.facebook.com/profile.php?viewas=100000686899395&id=61584353451934" className="w-8 h-8 bg-white/10 hover:bg-white/20 rounded-md flex items-center justify-center transition-colors">
                  ...
                  <a href="https://github.com/kor4softsas" className="w-8 h-8 bg-white/10 hover:bg-white/20 rounded-md flex items-center justify-center transition-colors">
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
