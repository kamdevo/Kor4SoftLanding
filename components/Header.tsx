    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/50">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#contacto" className="text-slate-700 hover:text-slate-900 transition-colors">
            Contacto
          </a>
        ...
        {/* Sign Up Button */}
        <button className="px-6 py-2 bg-slate-200 hover:bg-slate-300 text-slate-800 rounded-lg font-medium transition-colors">
          Contáctanos
        </button>
        </div>
      </div>
