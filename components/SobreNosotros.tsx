export default function SobreNosotros() {
  return (
    <section id="sobre-nosotros" className="container mx-auto px-4 py-20 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-blue-50 to-slate-100 rounded-2xl p-6 shadow-lg border border-slate-200">
